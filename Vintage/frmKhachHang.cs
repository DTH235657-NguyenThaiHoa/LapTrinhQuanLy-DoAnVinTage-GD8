...
namespace Vintage
{
    public partial class frmKhachHang : Form
    {
        ...
        private void frmKhachHang_Load(object sender, EventArgs e)
        {
            ...
            // In InitializeComponent or designer: set DataPropertyName = "TenKhachHang" for the column
            HoVaTen.DataPropertyName = "TenKhachHang";
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            foreach (DataRow r in table.Rows)
                            {
                                ...
                                lsp.TenKhachHang = r["TenKhachHang"].ToString();
                ...
                try
                {
                    ...
                    if (khachHang != null)
                    {
                        foreach (var p in khachHang)
                            table.Rows.Add(p.ID, p.TenKhachHang);
                    }
