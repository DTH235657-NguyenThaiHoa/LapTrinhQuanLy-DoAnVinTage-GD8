...
namespace Vintage
{
    public partial class frmNhanVien : Form
    {
        ...
        private void frmNhanVien_Load(object sender, EventArgs e)
        {
            ...
            HoVaTen.DataPropertyName = "TenNhanVien"; // or change column name
                                                      // ...
                ...
                try
                {
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            ...
                            {
                                NhanVien lsp = new NhanVien();
                                lsp.TenNhanVien = r["TenNhanVien"].ToString();
                                context.NhanVien.Add(lsp);
                            }
                            context.SaveChanges();
                ...
                try
                {
                    ...
                    if (nhanVien != null)
                    {
                        foreach (var p in nhanVien)
                            table.Rows.Add(p.ID, p.TenNhanVien);
                    }
